            ...
            <div class="col-lg-5 mb-30">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        ...
                        <img style="max-width: 70%; max-height: 120vh; margin: 0; " class=" rounded-4 fit" src="../controller/hinh/<?=$hinh?>" alt="">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-1">(<?=$so_luot_xem?>)</small>
                    </div>
                    <h3 class="font-weight-semi-bold mb-4"><?=number_format($giam_gia)?> %</h3>
                    <h3 class="font-weight-semi-bold mb-4"><?=number_format($don_gia)?> đ</h3>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1">
                            <a href="index.php?page=giohang" style="text-decoration: none; color:black;">Mua ngay</a>
                        </i></button>
                    </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            <p>Malcolm Gladwell là tác giả của năm cuốn sách bán chạy nhất của New York Times: 
                                ...
                                <p> Anh ấy cũng là người đồng sáng lập của Pushkin Industries, một công ty nội dung âm thanh sản xuất podcast Lịch sử xét lại, xem xét lại những điều vừa bị bỏ qua và hiểu lầm, và Broken Record, nơi anh ấy, Rick Rubin và Bruce Headlam phỏng vấn các nhạc sĩ trên nhiều lĩnh vực khác nhau. thể loại. Gladwell đã được đưa vào danh sách 100 người có ảnh hưởng nhất của Time và được giới thiệu 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media mb-4">
                                        <img src="./user/style/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
