                ...
                <div class="row pb-3">
                    <div class="col-12 pb-1">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div class="ml-2">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">Lọc</button>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <form class="product-item bg-light mb-4">
                            ...
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-70  picture mt-5 ml-lg-5" src="../controller/hinh/<?=$hinh?>" alt="">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5><?=number_format($don_gia)?></h5><h6 class="text-muted ml-2"><del>500.000 đ</del></h6>
                                </div>
